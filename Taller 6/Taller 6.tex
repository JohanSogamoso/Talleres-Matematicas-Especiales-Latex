...
\textcolor{ao(english)}{(\,4\,)} $\bf{\left\{\dfrac{n\,i\,+\,2}{3\,n\,i\,+\,5}\right\}}$.\\
 ...
 $$\dfrac{\dfrac{n i}{n}+\dfrac{2}{n}}{\dfrac{3n i}{n}+\dfrac{5}{n}} = \dfrac{i+\dfrac{2}{n}}{\dfrac{5}{n}+3i} \times \dfrac{3i-\dfrac{5}{n}}{\dfrac{5}{n}-3i} = \dfrac{\left(i+ \dfrac{2}{n} \right) \left(3i- \dfrac{5}{n} \right)}{ \left( \dfrac{5}{n} \right)^{2} + (3i)^{2} } $$
